...
![Writing workspace in dark mode](../assets/brand/workspace-dark.png)

![Writing workspace in light mode](../assets/brand/workspace-light.png)
...
![Chinese reading note with a sidenote](../assets/brand/reading-light.png)

![Chinese reading note in dark mode](../assets/brand/reading-dark.png)
...
![Flowchart with optional Litos Companion enhancement](../assets/brand/companion-diagram-dark.png)
